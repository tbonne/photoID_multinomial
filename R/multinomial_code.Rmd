...
#get shapefile of the St.Lawrence
...
#fit the model
fit.int.structured.multi <- brm(bf_cat, data=df.structured.multinom, cores=4,chains=4, iter=1000, backend = "cmdstanr", threads = threading(10), control = list(adapt_delta=0.95),
                                prior = prior("normal(0,1)", class = "Intercept") +
                                  prior("lkj_corr_cholesky(2)", class="cor") +
                                  prior("student_t(3, 0, 1)", class="sd", dpar="muy2") +
                                  prior("student_t(3, 0, 1)", class="sd", dpar="muy3") +
